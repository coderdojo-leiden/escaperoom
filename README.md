...
We beginnen met een leeg project waar alle benodigde sprites al in zitten. Op deze manier hoef je je alleen maar druk te maken om de code-blokken! Dit lege project kun je in de Scratch editor openen via ons [escaperoom startproject](https://scratch.mit.edu/projects/629181159/editor). Gebruik je de Sratch offline editor (die je [hier](https://scratch.mit.edu/download) kunt downloaden), dan kun je het startproject ook [hier](resources/escaperoom.sb3) downloaden en daarna in de offline editor laden.
