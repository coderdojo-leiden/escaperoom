...
We beginnen met een leeg project waar alle benodigde sprites al in zitten. Op deze manier hoef je je alleen maar druk te maken om de code-blokken! Dit lege project kun je in de Scratch editor openen via ons [escaperoom startproject](https://scratch.mit.edu/projects/756757402/editor) (op coderdojo-leiden.nl/escaperoom-start-nl). Gebruik je de Scratch offline editor (die je op [scratch.mit.edu/download](https://scratch.mit.edu/download) kunt downloaden), dan kun je het startproject ook [downloaden](resources/escaperoom_nl.sb3) en daarna in de offline editor laden.
